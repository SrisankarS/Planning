...
export class ManageComponent implements OnInit {
  ...
  onDeleteCinemaHall(auditoriumId: number): void {
    this._globalService.deleteAuditorium(auditoriumId).subscribe();
    this.load();
  }
  ...
  onDeleteShow(showId: number): void {
    this._globalService.deleteShow(showId).subscribe();
    window.location.reload();
  }
  ...
  onDeleteMovie(movieId: number): void {
   this._globalService.deleteMovie(movieId).subscribe();
   //window.location.reload();
  }
}
